...
export default function WhyChoose() {
    ...
    return (
        <section className="relative overflow-hidden bg-gray-50 py-28">
            {/* Background Glow */}
            <div className="absolute left-0 top-0 h-96 w-96 rounded-full bg-violet-300/20 blur-[140px]" />
            <div className="absolute bottom-0 right-0 h-96 w-96 rounded-full bg-indigo-300/20 blur-[140px]" />
            ...
            <div className="relative mx-auto max-w-7xl px-6">
                <div className="grid items-center gap-20 lg:grid-cols-2">
                    ...
                    >
                        <div className="absolute h-[600px] w-[600px] rounded-full bg-gradient-to-r from-violet-500/20 to-indigo-500/20 blur-[140px]" />
                        ...
                        <motion.div
                            ...
                            className="relative w-full max-w-2xl overflow-hidden rounded-[36px] border border-white/30 bg-white/70 p-8 shadow-[0_40px_80px_rgba(0,0,0,0.12)] backdrop-blur-2xl"
                        >
                                ...
                                <div className="mt-12 grid grid-cols-2 gap-5 md:grid-cols-4">
                                    ...
                                    {[
                                        ...
                                        >
                                            ...
                                            <h3 className="mt-3 text-3xl font-bold text-[#6C4CF6]">
                                                {item.value}
                                            </h3>
                                        </motion.div>
                                    ))}
